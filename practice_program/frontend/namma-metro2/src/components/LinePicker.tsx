...
export default function LinePicker({ role, line, station, onLineChange, onStationChange }: Props) {
  ...
  return (
    <Card title={title} icon={icon} allowOverflow>
      {/* Line tabs */}
      <div>
        <span style={{
          display: 'block', fontSize: 9, fontFamily: 'var(--mono)', letterSpacing: 1.5,
          textTransform: 'uppercase', color: 'var(--muted2)', marginBottom: 6
        }}>Select Line</span>
      ...
      <div ref={wrapRef} style={{ position: 'relative' }}>
        ...
        <button onClick={openDropdown} style={{
          ...
          <span style={{
            fontSize: 9, color: 'var(--muted2)', flexShrink: 0,
