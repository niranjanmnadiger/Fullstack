    ...
    <div className="animate-fadeUp" style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {[
            { label: 'Board around', val: '~' + fmtTime(firstTrain), color: 'var(--purple-ll)', sub: legs[0].from },
            { label: 'Arrive around', val: '~' + fmtTime(finalArrive), color: 'var(--green-ll)', sub: legs[legs.length - 1].to },
        ...
        <div style={{
          ...
          ⏱ Times are estimates based on published frequencies — actual trains may vary by a few minutes.
        </div>
